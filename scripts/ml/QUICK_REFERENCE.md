# BloodVital ML - Quick Reference Card
...
python generate_synthetic_data.py --num-samples 10000 --output "C:/Scratch/bloodvital/data/ml/large_dataset.json"
```
...
python explore_data.py --input "C:/Scratch/bloodvital/data/ml/synthetic_lab_reports.json" --mode stats

# Full pipeline
python generate_synthetic_data.py --num-samples 5000 && \
python example_training_pipeline.py --input "C:/Scratch/bloodvital/data/ml/synthetic_lab_reports.json"
```
...
6. Integrate into BloodVital: Add to upload flow
