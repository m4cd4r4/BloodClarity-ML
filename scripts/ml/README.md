# BloodClarity ML Synthetic Data Generation
...
The `generate_comprehensive_training_data.py` script generates realistic synthetic blood test reports across 53 international lab formats with proper NER (Named Entity Recognition) labels for training machine learning models.

## Features

- **165 Biomarkers**: Comprehensive coverage across 20+ medical categories
- **53 Lab Formats**: International coverage (US, UK, Australia, India, Philippines, Indonesia, Mexico, Brazil, and more)
...
### Basic Usage (Generate 10,000 samples)
...
```bash
python generate_comprehensive_training_data.py --output ./output.json
```

### With Custom Random Seed

```bash
python generate_comprehensive_training_data.py --num-samples 5000 --seed 123
```
...
The script includes 165 biomarkers across these categories:
...
- Or absolute paths appropriate to your operating system
...
For questions or issues, please open an issue on [GitHub](https://github.com/m4cd4r4/bloodclarity-ml/issues).
