# BloodVital ML Synthetic Data Generation - File Index

## Overview

This directory contains a complete toolkit for generating synthetic lab report data to train TinyBERT NER models for biomarker extraction in the BloodVital application.
...
- **C:\Scratch\bloodvital\src\data\biomarkers.ts**: Source biomarker database
- **C:\Scratch\bloodvital\src\types\index.ts**: TypeScript type definitions
- **C:\Scratch\bloodvital\data\ml\**: Output directory for generated data
...
7. **Integrate with BloodVital**: Add to upload flow

## Contact

For questions, issues, or contributions, contact the BloodVital development team.
